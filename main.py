...
ACCESS_TOKEN = os.getenv("LINE_ACCESS_TOKEN", "Vpo1FkVV+8fK9yVbI6CAtturC8tBwgsu8/6uBcC2sI3Iz80Stcw2OG8W+pSVRYPF3MTIB/Mio1yNBGH+RWFyDEaMgMUBnG8+YF+kChkCVm+TEa0p00A3rfo4AmK2DhMh1/YpX8PV6B7gG0OE9+bxDwdB04t89/1O/w1cDnyilFU=")
CHANNEL_SECRET = os.getenv("LINE_CHANNEL_SECRET", "88f29138e1e9ecbbc22c67c7fe46c6f9")

# ข้อมูล Gemini api key
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyAHYhQDpv00J-40fkJ9T1WorxvgOe8lBdM")
...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        ...
        "งาน BUU-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 25 มกราคม ปีค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์ เวลา 9:00 น. - 16:00 น. และมีคนเข้าร่วม 170 กว่าคน",
        "มหาวิทยาลัยบูรพา สาขาวิชาAI ปีการศึกษา 2565 มีนักศึกษาจำนวน 100 คน มีอาจารย์ที่ปรึกษา 10 คน",
        "เบอร์เกอร์ไก่ย่างของ Lawson ที่อร่อยที่สุดคือ เบอร์เกอร์ไก่นิวออรีน",
        "นมที่อร่อยที่สุดคือ นมตราหมี",
        "พี่ AI ของ Clicknext มี พี่ปาล์ม พี่เจ๋ง พี่ชวน"
    ]
